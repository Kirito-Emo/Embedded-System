...
## 
## Makefile     : Chart.mk
## Generated on : Mon Jun 03 18:06:32 2024
...
START_DIR                 = C:/Users/miche/Desktop/UNIVER~1/MAGIST~1/PRIMOA~1/SECOND~1/AUTOMA~1/SECOND~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
%.obj : $(START_DIR)/Chart_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Chart_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Chart_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Chart_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Chart.obj : $(START_DIR)/Chart_ert_rtw/Chart.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/Chart_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
